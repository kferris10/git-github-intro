...
- [Slidify](http://slidify.org/).  This is how I got started (though I would not recommend getting started by trying to figure out Slidify).  I've also not yet been able to get the `publish` function to work on a Windows machine. 
